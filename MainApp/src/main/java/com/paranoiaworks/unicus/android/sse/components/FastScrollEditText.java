...
public class FastScrollEditText extends SecureEditText implements FastScrollable {
	...
	public FastScrollEditText(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		createFastScrollDelegate(context);
	}

	@TargetApi(Build.VERSION_CODES.LOLLIPOP)
	public FastScrollEditText(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
