 ...
 * @version 1.1.1
 */
public class CipherInputStreamCTRNCV3 extends PWCipherInputStream implements WithMAC {
	...
	public CipherInputStreamCTRNCV3(final InputStream in, byte[] nonce, byte[] key, byte[] macKey, Encryptor.AlgorithmBean algorithmBean) {
