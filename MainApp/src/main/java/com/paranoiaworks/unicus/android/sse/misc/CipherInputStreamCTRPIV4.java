 ...
 * @version 1.0.1
 */
public class CipherInputStreamCTRPIV4 extends PWCipherInputStream implements WithMAC {
	...
	public CipherInputStreamCTRPIV4(final InputStream in, byte[] nonce, byte[] key, byte[] macKey, Encryptor.AlgorithmBean algorithmBean) {
